# stworzenie rozszerzonego skryptu pytonowego
import requests
import argparse
...
class Brewery:
    ...
    def __str__(self):
        return (
            ...
            f"Miasto: {self.city}\n"
            f"Adres: {self.street}, {self.state}, {self.postal_code}\n"
            f"Kraj: {self.country}\n"
...
def get_arguments():
    parser = argparse.ArgumentParser(
        description="Pobiera listę browarów z Open Brewery DB"
    )

    parser.add_argument(
        "--city",
        type=str,
        help="Nazwa miasta, z którego mają być pobrane browary"
    )
